...
import { CANVAS_WIDTH, CANVAS_HEIGHT, GRID_SIZE, SNAP_THRESHOLD } from '../utils/canvasConstants';
 ...
 */
const useSmartGuides = ({ showGrid = false, onElementChange }) => {
     ...
     * Snaps to grid or canvas guides during drag
     */
