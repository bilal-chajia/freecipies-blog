 ...
 * ========================
 * Implementation for Mistral AI models (Large 3, Ministral, Codestral).
 * Uses Mistral API (OpenAI-compatible format).
 */
...
export class MistralProvider implements IAIProvider {
    ...
    async generateContent(request: GenerateContentRequest): Promise<GenerateContentResponse> {
        ...
        const model = request.model || 'mistral-large-3';
        ...
        try {
            ...
            return {
                success: false,
                error: `Mistral generation failed: ${message}`,
            };
        }
    }
