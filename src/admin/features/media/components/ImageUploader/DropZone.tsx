...
export interface DropZoneProps {
  ...
  onUrlsImport?: (urls: string[]) => void;
  allowMultiple?: boolean;
  maxFileSizeMB?: number;
}

export default function DropZone({ onFileSelect, onFilesSelect, onUrlImport, onUrlsImport, allowMultiple = false, maxFileSizeMB = 50 }: DropZoneProps) {
  ...
  }, [onFileSelect, onFilesSelect, onUrlImport, createParticles, allowMultiple, onUrlsImport]);
