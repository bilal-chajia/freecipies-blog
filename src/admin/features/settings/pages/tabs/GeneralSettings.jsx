...
} from '@admin/features/settings/components/GutenbergTabs.jsx';
...
export const generalSettingsTabs = [
    { value: 'site', label: 'Site Information', icon: Info },
    { value: 'localization', label: 'Localization', icon: Languages },
];

const GeneralSettings = ({ formData, handleInputChange, activeSection = 'site' }) => {
    return (
        <>
            {activeSection === 'site' && (
