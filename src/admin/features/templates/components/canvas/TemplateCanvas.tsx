          ...
          return (
            <textarea
              ...
              style={{
                ...
                height: 'auto',
                padding: '8px',
                fontSize: ((editingElement as TextElement).font_size || 32) * actualScale,
                fontFamily: (editingElement as TextElement).font_family || 'Inter, sans-serif',
                fontWeight: (editingElement as TextElement).font_weight || 'normal',
                fontStyle: (editingElement as TextElement).font_style || 'normal',
                textAlign: (editingElement as TextElement).text_align || 'center',
                ...
                resize: 'vertical',
                zIndex: 1000,
                lineHeight: (editingElement as TextElement).line_height || 1.4,
                letterSpacing: (editingElement as TextElement).letter_spacing || 0,
                overflow: 'visible',
