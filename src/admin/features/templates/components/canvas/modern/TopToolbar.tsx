...
const TopToolbar: React.FC<TopToolbarProps> = ({ onExport, onPreview, onExportImage, isPreviewOpen }) => {
    ...
    const getTriggerRect = (ref: React.RefObject<HTMLDivElement | null>): DOMRect | null => ref.current?.getBoundingClientRect() ?? null;
