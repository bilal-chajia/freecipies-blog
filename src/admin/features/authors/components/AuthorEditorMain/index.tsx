...
interface AuthorEditorMainProps {
  formData: AuthorFormData;
  onInputChange: (field: keyof AuthorFormData, value: unknown) => void;
  bioData: LegacyBioFields;
  onBioChange: (bio: LegacyBioFields) => void;
}
          ...
          <div className="space-y-2">
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm">
              <BlockEditor
                ...
                onChange={(value: string) => onBioChange({ ...bioData, fullBio: value })}
