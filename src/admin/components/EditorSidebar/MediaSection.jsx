                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                        ...
                        {featuredUrl ? (
                            ...
                            <button
                                onClick={() => onMediaDialogOpen('image')}
                                className="w-full h-32 border-2 border-dashed rounded-lg flex flex-col items-center justify-center gap-2 hover:bg-accent hover:border-primary/20 transition-all"
                            >
