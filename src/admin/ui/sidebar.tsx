...
function Sidebar({
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props as React.ComponentPropsWithoutRef<typeof Sheet>}>
        <SheetContent
...
function SidebarContent({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto overscroll-y-contain group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props} />
  );
