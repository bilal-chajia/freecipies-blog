...
type CalendarClassNames = Record<string, string>

export function buildCalendarClassNames(
  defaultClassNames: CalendarClassNames,
  overrides: CalendarClassNames = {},
  buttonVariant: CalendarProps['buttonVariant'] = 'ghost',
  captionLayout: CalendarProps['captionLayout'] = 'label',
