...
import { ae as createAstro, c as createComponent, m as maybeRenderHead, ag as addAttribute, am as renderScript, a as renderTemplate, r as renderComponent, an as Fragment, ax as defineScriptVars, ak as unescapeHTML, al as renderSlot } from '../../chunks/astro/server_Bsmdvglz.mjs';
import { $ as $$Layout } from '../../chunks/Layout_Cyf8gyLe.mjs';
/* empty css                                     */
import '../../chunks/pinterest.schema_DDOHgYvi.mjs';
import { a as getArticles, g as getArticleBySlug } from '../../chunks/articles.service_hseUetrK.mjs';
import { b as getAuthorById } from '../../chunks/authors.service_5yxqEIeb.mjs';
import { b as getCategoryById } from '../../chunks/categories.service_DP4au7sC.mjs';
import { b as hydrateArticle } from '../../chunks/hydration_D2T5lKEB.mjs';
...
const $$PopularRecipes = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="popular-recipes-widget" data-astro-cid-gjgjpeik> <div class="widget-header" data-astro-cid-gjgjpeik> <span class="header-dot" data-astro-cid-gjgjpeik></span> <h3 data-astro-cid-gjgjpeik>Popular Recipes</h3> </div> ${recipes.length > 0 ? renderTemplate`<div class="recipe-list" data-astro-cid-gjgjpeik> ${recipes.map((recipe) => renderTemplate`<a${addAttribute(`/recipes/${recipe.slug}`, "href")} class="recipe-item" data-astro-cid-gjgjpeik> <div class="recipe-content" data-astro-cid-gjgjpeik> <h4 class="recipe-title" data-astro-cid-gjgjpeik>${recipe.label}</h4> <div class="recipe-meta" data-astro-cid-gjgjpeik> ${recipe.categoryLabel && renderTemplate`<span class="category"${addAttribute(`color: ${recipe.category?.color || "#666"}`, "style")} data-astro-cid-gjgjpeik> ${recipe.categoryLabel} </span>`} ${recipe.recipeJson?.cookTime && renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-gjgjpeik": true }, { "default": async ($$result2) => renderTemplate` <span class="separator" data-astro-cid-gjgjpeik>•</span> <span class="cook-time" data-astro-cid-gjgjpeik>${recipe.recipeJson.cookTime}</span> ` })}`} </div> </div> ${recipe.imageUrl && renderTemplate`<img${addAttribute(recipe.imageUrl, "src")}${addAttribute(recipe.imageAlt || recipe.label, "alt")} class="recipe-thumb" width="80" height="80" loading="lazy" data-astro-cid-gjgjpeik>`} </a>`)} </div>` : renderTemplate`<p class="no-recipes" data-astro-cid-gjgjpeik>More recipes coming soon!</p>`} </div> `;
...
const $$RecipeLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$1 || (_a$1 = __template$1(["", " <script>(function(){", '\n  // Simple view tracking\n  const trackView = async () => {\n    try {\n      await fetch(`/api/views/${slug}`, { method: "POST" });\n    } catch (e) {\n      // Ignore errors silently (e.g. ad blockers)\n    }\n  };\n\n  // Run when the page is ready\n  if (document.readyState === "complete") {\n    trackView();\n  } else {\n    window.addEventListener("load", trackView);\n  }\n})();<\/script>  ', ""], ["", " <script>(function(){", '\n  // Simple view tracking\n  const trackView = async () => {\n    try {\n      await fetch(\\`/api/views/\\${slug}\\`, { method: "POST" });\n    } catch (e) {\n      // Ignore errors silently (e.g. ad blockers)\n    }\n  };\n\n  // Run when the page is ready\n  if (document.readyState === "complete") {\n    trackView();\n  } else {\n    window.addEventListener("load", trackView);\n  }\n})();<\/script>  ', ""])), renderComponent($$result, "Layout", $$Layout, { "title": recipe.metaTitle || recipe.label, "description": recipe.metaDescription || recipe.shortDescription, "image": recipe.imageUrl || void 0, "data-astro-cid-763jalmv": true }, { "default": async ($$result2) => renderTemplate`${maybeRenderHead()}<article class="recipe-page" data-astro-cid-763jalmv> <div class="recipe-container" data-astro-cid-763jalmv> <!-- Main Content Column --> <div class="main-content" data-astro-cid-763jalmv> <!-- Category Badge --> ${recipe.categoryLabel && renderTemplate`<a${addAttribute(`/categories/${recipe.categorySlug}`, "href")} class="category-badge"${addAttribute(`--badge-color: ${categoryColor};`, "style")} data-astro-cid-763jalmv> ${recipe.categoryLabel} </a>`} <!-- Recipe Title --> <h1 class="recipe-title" data-astro-cid-763jalmv>${recipe.label}</h1> <!-- Short Description --> ${recipe.shortDescription && renderTemplate`<p class="recipe-description" data-astro-cid-763jalmv>${recipe.shortDescription}</p>`} <!-- Social Share Bar --> ${renderComponent($$result2, "SocialShareBar", $$SocialShareBar, { "title": recipe.label, "readingTime": `${readingTime} Min Read`, "data-astro-cid-763jalmv": true })} <!-- Author Card --> ${renderComponent($$result2, "RecipeAuthorCard", $$RecipeAuthorCard, { "authorName": author?.name || recipe.authorName, "authorImage": author?.imageUrl || void 0, "authorRole": author?.job || "Blogger", "lastUpdated": recipe.publishedAt || void 0, "viewCount": recipe.viewCount, "data-astro-cid-763jalmv": true })} <!-- Disclosure Notice --> <div class="disclosure-notice" data-astro-cid-763jalmv> <strong data-astro-cid-763jalmv>Disclosure:</strong> This website may contain affiliate links, which
  ...
  )} </div> </div>`} <!-- Popular Recipes --> ${renderComponent($$result2, "PopularRecipes", $$PopularRecipes, { "currentSlug": recipe.slug, "limit": 5, "data-astro-cid-763jalmv": true })} <!-- Newsletter Widget --> ${renderComponent($$result2, "NewsletterWidget", $$NewsletterWidget, { "data-astro-cid-763jalmv": true })} </div> </aside> </div> </article> `, "head": async ($$result2) => renderTemplate`${recipe.imageUrl && renderTemplate`<link rel="preload" as="image"${addAttribute(recipe.imageUrl, "href")}>`}` }), defineScriptVars({ slug: recipe.slug }), renderScript($$result, "C:/Users/Poste/Desktop/SaaS Astro/freecipies-blog/src/layouts/RecipeLayout.astro?astro&type=script&index=0&lang.ts"));
...
const $$SEO = createComponent(($$result, $$props, $$slots) => {
  ...
  const siteUrl = Astro2.site?.toString() || "https://domain.com";
  ...
  return renderTemplate`<!-- Primary Meta Tags --><title>${title}</title><meta name="title"${addAttribute(title, "content")}><meta name="description"${addAttribute(description, "content")}><link rel="canonical"${addAttribute(canonicalURL, "href")}><!-- Open Graph / Facebook --><meta property="og:type"${addAttribute(type, "content")}><meta property="og:url"${addAttribute(canonicalURL, "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(imageUrl, "content")}>${imageAlt && renderTemplate`<meta property="og:image:alt"${addAttribute(imageAlt, "content")}>`}<meta property="og:site_name" content="Freecipies">${publishedTime && renderTemplate`<meta property="article:published_time"${addAttribute(publishedTime, "content")}>`}${modifiedTime && renderTemplate`<meta property="article:modified_time"${addAttribute(modifiedTime, "content")}>`}${author && renderTemplate`<meta property="article:author"${addAttribute(author.name, "content")}>`}<!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"${addAttribute(canonicalURL, "content")}><meta property="twitter:title"${addAttribute(title, "content")}><meta property="twitter:description"${addAttribute(description, "content")}><meta property="twitter:image"${addAttribute(imageUrl, "content")}>${imageAlt && renderTemplate`<meta property="twitter:image:alt"${addAttribute(imageAlt, "content")}>`}<!-- Additional Meta Tags --><meta name="robots" content="index, follow"><meta name="googlebot" content="index, follow"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta charset="UTF-8"><!-- Schema.org JSON-LD -->${type === "website" && renderTemplate(_a || (_a = __template(['<script type="application/ld+json">', "<\/script>"])), unescapeHTML(JSON.stringify({
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let author = null;
  let category = null;
  const rawRecipe = await getArticleBySlug(runtime.env.DB, slug, "recipe");
  if (!rawRecipe) {
    return new Response("Recipe not found", { status: 404 });
  }
  const recipe = hydrateArticle(rawRecipe);
  const recipeDetails = recipe.recipeJson || void 0;
  if (rawRecipe.authorId) {
    author = await getAuthorById(runtime.env.DB, rawRecipe.authorId);
  }
  if (rawRecipe.categoryId) {
    category = await getCategoryById(runtime.env.DB, rawRecipe.categoryId);
  }
...
</p>`} </article> `, "seo": async ($$result2) => renderTemplate`${renderComponent($$result2, "SEO", $$SEO, { "slot": "seo", "title": pageTitle, "description": pageDescription, "type": "recipe", "publishedTime": recipe.publishedAt || void 0, "author": { name: author?.name || "Freecipies Team" }, "image": recipe.imageUrl || "", "imageAlt": recipe.imageAlt || void 0, "recipe": recipeDetails ? {
