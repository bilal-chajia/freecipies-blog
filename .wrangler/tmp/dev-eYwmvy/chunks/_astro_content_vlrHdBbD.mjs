...
import { ao as objectType, ap as dateType, aq as arrayType, ar as stringType, A as AstroError, as as UnknownContentCollectionError, c as createComponent, at as RenderUndefinedEntryError, ak as unescapeHTML, a as renderTemplate, e as escape, au as renderUniqueStylesheet, av as renderScriptElement, aw as createHeadAndContent, r as renderComponent } from './astro/server_Bsmdvglz.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DyNMLg3X.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_OFKDI66F.mjs').then(n => n._);
