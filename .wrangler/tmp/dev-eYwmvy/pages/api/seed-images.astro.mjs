...
import { A as AppError, E as ErrorCodes, a as formatSuccessResponse } from '../../chunks/error-handler_CIGPYhyT.mjs';
  ...
  try {
    ...
    for (const img of SEED_IMAGES) {
      try {
        ...
        const variants = {
          original: { url: uploadResult.url, width: 800, height: 600 },
          // Approximate
          lg: { url: uploadResult.url, width: 800, height: 600 },
          md: { url: uploadResult.url, width: 800, height: 600 },
          sm: { url: uploadResult.url, width: 800, height: 600 },
          xs: { url: uploadResult.url, width: 800, height: 600 }
        };
        const mediaData = {
          name: img.name,
          altText: img.name,
