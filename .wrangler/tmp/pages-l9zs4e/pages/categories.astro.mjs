...
import { e as extractImage, g as getImageSrcSet, f as hydrateCategory } from '../chunks/hydration_PCOoIFzn.mjs';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "All Categories", "description": "Browse all recipe categories" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container mx-auto px-4 py-12"> <h1 class="text-4xl font-bold text-center mb-12">Browse Categories</h1> <h2 class="sr-only">Category list</h2> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> ${categories.map((category) => renderTemplate`${renderComponent($$result2, "CategoryCard", $$CategoryCard, { "category": category })}`)} </div> </div> ` })}`;
